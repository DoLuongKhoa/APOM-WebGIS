import './map_pm_mod.html';

Template.map_pm_mod.rendered = function () {
    window.require([
        "esri/Map",
        ...
        var layer = new MapImageLayer({
            ...
            url: "http://113.175.118.161:6080/arcgis/rest/services/PM25_MOD/MapServer/",
            opacity: 0.5,
        });
        var map = new Map({
            basemap: "streets",
        ...
        var featureLayer = new FeatureLayer({
            ...
            url: "http://113.175.118.161:6080/arcgis/rest/services/PM25_MOD/MapServer/0",
            opacity: 0.5,
            timeInfo: {
